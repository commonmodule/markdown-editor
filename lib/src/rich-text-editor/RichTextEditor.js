...
export default class RichTextEditor extends DomNode {
    ...
    createToolbarButtonByIndex(ToolbarButton, buttonIndex) {
        if (buttonIndex === 0) {
            ...
            return this.createToolbarButton(ToolbarButton, "link", new MarkdownEditorConfig.LinkIcon(), () => this.editableArea.editLink());
        }
            ...
            return this.createToolbarButton(ToolbarButton, "image", new MarkdownEditorConfig.ImageIcon(), () => this.editableArea.addImage());
        }
        else if (buttonIndex === 12) {
            return this.createToolbarButton(ToolbarButton, "youtube", new MarkdownEditorConfig.YouTubeIcon(), () => this.editableArea.addYouTubeVideo());
        }
    }
    updateToolbar() {
